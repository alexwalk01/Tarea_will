    ...
    Route::middleware(['auth', CheckTokenExpiration::class])->group(function () {
        ...
        ->middleware(\App\Http\Middleware\CheckPermissions::class.':juegos,view');

    Route::get('/juego/{id}', [JuegoController::class, 'show'])
        ->middleware(\App\Http\Middleware\CheckPermissions::class.':juegos,view');

    Route::get('/materias', [MateriaController::class, 'index'])
        ->middleware(\App\Http\Middleware\CheckPermissions::class.':materias,view');

    Route::get('/materia/{id}', [MateriaController::class, 'show'])
        ->middleware(\App\Http\Middleware\CheckPermissions::class.':materias,view');

    Route::get('/proyectos', [ProyectoController::class, 'index'])
        ->middleware(\App\Http\Middleware\CheckPermissions::class.':proyectos,view');
