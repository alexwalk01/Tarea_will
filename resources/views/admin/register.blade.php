            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="security_question_1" class="col-md-4 col-form-label text-md-end">Security Question 1</label>
                            <div class="col-md-6">
                                <select id="security_question_1" class="form-control @error('security_question_1') is-invalid @enderror" name="security_question_1" required>
                                    <option value="favorite_movie">What's your favorite movie?</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            <label for="security_answer_1" class="col-md-4 col-form-label text-md-end">Security Answer 1</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="security_question_2" class="col-md-4 col-form-label text-md-end">Security Question 2</label>
                            <div class="col-md-6">
                                <select id="security_question_2" class="form-control @error('security_question_2') is-invalid @enderror" name="security_question_2" required>
                                    <option value="first_pet">What's the name of your first pet?</option>
                                </select>
                        ...
                        <div class="row mb-3">
                            <label for="security_answer_2" class="col-md-4 col-form-label text-md-end">Security Answer 2</label>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="privacy-check">
                                        I accept the <a href="#" target="_blank">privacy notice</a>.
                                    </label>
                                </div>
                            </div>
                        </div>
